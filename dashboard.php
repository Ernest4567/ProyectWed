<?php 
// Definir la URL base
$url_base = "http://localhost/ProyectWed/"; 
...
<head>
  ...
  <link rel="icon" href="<?php echo $url_base; ?>imagen/favicon.ico">
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <div class="user-info">
      <img src="<?php echo $url_base; ?>imagen/<?php echo $usuario['imagen']; ?>" class="user-avatar" alt="Avatar">
      <h6 class="mb-1"><?php echo $usuario['nombre']; ?></h6>
      <small class="text-muted">Administrador</small>
    </div>
    
    <div class="sidebar-nav">
      <a href="<?php echo $url_base; ?>modules/clientes/readcliente.php" class="nav-link">
        <i class="bi bi-people-fill"></i>
        <span class="sidebar-text">Clientes</span>
      </a>
      <a href="<?php echo $url_base; ?>modules/proveedores/readproveedores.php" class="nav-link">
        <i class="bi bi-truck"></i>
        <span class="sidebar-text">Proveedores</span>
      </a>
      <a href="<?php echo $url_base; ?>modules/productos/readproducto.php" class="nav-link">
        <i class="bi bi-box-seam"></i>
        <span class="sidebar-text">Productos</span>
      </a>
      <a href="<?php echo $url_base; ?>modules/ventas/readventas.php" class="nav-link">
        <i class="bi bi-cart-check"></i>
        <span class="sidebar-text">Ventas</span>
      </a>
      <a href="<?php echo $url_base; ?>modules/compras/readcompras.php" class="nav-link">
    ...
    <div class="mt-auto p-3">
      <a href="<?php echo $url_base; ?>logout.php" class="nav-link text-danger">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <a class="dropdown-item text-danger" href="<?php echo $url_base; ?>logout.php">
          ...
          <div class="chart-container">
            ...
            <div class="row g-3">
              <div class="col-md-3 col-6">
                <a href="<?php echo $url_base; ?>modules/clientes/readcliente.php" class="btn btn-outline-primary w-100 py-3">
                  <i class="bi bi-people-fill display-6 d-block mb-2"></i>
                  Gestionar Clientes
                </a>
              </div>
              <div class="col-md-3 col-6">
                <a href="<?php echo $url_base; ?>modules/productos/readproducto.php" class="btn btn-outline-success w-100 py-3">
                  <i class="bi bi-box-seam display-6 d-block mb-2"></i>
                  Gestionar Productos
                </a>
              </div>
              <div class="col-md-3 col-6">
                <a href="<?php echo $url_base; ?>modules/ventas/readventas.php" class="btn btn-outline-warning w-100 py-3">
